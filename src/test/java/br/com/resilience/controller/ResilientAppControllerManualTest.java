...
import br.com.resilience.config.RestTemplateConfig;
...
class ResilientAppControllerManualTest {
    ...
    @Autowired
    private ResilientAppController resilientAppController;
...
//    @RepeatedTest(5)
    public void testCircuitBreaker() {
        ...
        ResponseEntity<String> response = resilientAppController.circuitBreakerApi();
